...
`,w=(0,o.default)(d.L_).attrs({dark:!0,fontSize:"1rem"})`
  text-align: center;
  line-height: 24px;
...
`,v=(0,o.default)(d.L_).attrs({dark:!0,fontSize:"0.625rem"})`
  text-align: center;
  line-height: 24px;
...
`},94748:(e,t,n)=>{n.d(t,{Od:()=>l,L_:()=>o});var a=n(30009),i=n(68212);const r=a.css`
  font-family: 'Source Sans Pro';
  font-size: 0.875rem;
  line-height: 20px;
`,o=a.default.div`
...
`}}]);
//# sourceMappingURL=354.434b62fa.chunk.js.map