...
const TestimonialCard = ({
  ...
  return (
    ...
    >
      <div className="flex h-[575px] w-48 flex-col items-center justify-between rounded-2xl bg-white bg-opacity-95 px-4 py-8 text-center font-medium text-[#3578DE] sm:h-[475px] sm:w-64 sm:max-w-xs md:h-[448px] md:w-auto md:max-w-sm md:px-6">
