...
const SevenSupporters = ({
  ...
  return (
    <main className="bg-[#F3F8FF]">
      {/* HERO */}
      <div className="relative w-full items-center overflow-hidden md:px-5 md:px-[260px]">
        ...
        <section className="relative my-24 overflow-hidden md:px-20 md:pt-24">
          <div className="mx-auto flex flex-col items-center px-5 text-center md:items-start md:px-10 md:text-left">
              ...
              <div className="relative">
                ...
                >
                  {section2.text.map((p, i) => (
                    <p
                      key={i}
                      className="py-2 text-left font-normal text-gray-700 md:text-2xl"
                    >
                      {p}
                    </p>
                  ))}
        ...
        <section className="my-10 mt-24">
          ...
          <div className="my-5 grid grid-cols-2 gap-2 md:my-20 md:grid-cols-4 md:gap-6">
            {section4.cardtitle.map((title, i) => (
              <div
                key={i}
                className="flex flex-col rounded-2xl border border-[#bcc7d4] p-2 text-center shadow-sm shadow-xl md:my-0 md:w-[276px] md:items-start md:p-6 md:text-left"
              >
