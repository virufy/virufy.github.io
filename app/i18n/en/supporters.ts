...
const supporters: Supporters = {
  ...
  supportersList: [
    ...
    { img: DriveLogo, alt: 'Drive', link: 'https://drive.hhs.gov/' },
    {
      img: UniversityFukuiLogo,
      alt: 'University Fukui',
      link: 'https://www.u-fukui.ac.jp/eng',
    },
    { img: IdimeLogo, alt: 'Idime', link: 'https://idime.com.co/' },
    {
      img: PillsburyLogo,
      alt: 'Pillsbury',
      link: 'https://www.pillsburylaw.com/en/',
    },
    { img: XoorLogo, alt: 'Xoor', link: 'https://xoor.io/en/' },
    {
      img: SherlockCommunicationsLogo,
      alt: 'Sherlock Communications',
      link: 'https://www.sherlockcomms.com/',
    },
    { img: NuvuLogo, alt: 'Nuvu', link: 'https://www.nuvu.cc/' },
    { img: SPILogo, alt: 'SPI', link: 'https://spiamericas.com/en/home/' },
    {
      img: DevlightsLogo,
      alt: 'Devlights',
      link: 'https://www.devlights.com/',
    },
    { img: FenwickLogo, alt: 'Fenwick', link: 'https://www.fenwick.com/' },
    {
      img: OlarteLogo,
      alt: 'Olarte Moure',
