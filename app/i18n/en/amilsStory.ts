...
const amilsStory: AmilsStory = {
  sectionAmil: {
    ...
    textAmil: [
      "Born and raised in the Silicon Valley in an immigrant family, Amil attended homeschooling and began studying at community college while 14 years old. Amil father's dedication to social service shaped him, with a childhood filled with volunteer activities such as feeding the homeless at soup kitchens. Amil would take his first job as a software consultant developing image recognition technology for automated grading of tests in K-12 schools.",
