...
const amilsStory: AmilsStory = {
  sectionAmil: {
    ...
    imgCaption: [
      'アミルが南米コロンビアでVirufyの臨床試験を支援する看護スタッフと共に。',
      'アミルがZenITプログラミングスクールで日本の学生やスタッフと共に。',
      'アミルが元首相で現在のNATO議長マーク・ルッテと出会った場面。',
    ],
    textAmil: [
      '移民家庭でシリコンバレーに生まれ育ったアミルは、ホームスクーリングを受け、14歳でコミュニティカレッジでの学びを始めました。アミルの父は社会奉仕に尽力しており、彼はホームレスに食事を提供するスープキッチンでのボランティア活動などに参加しながら育ちました。アミルはK-12の学校でテストの自動採点技術を開発するソフトウェアコンサルタントとして初めての仕事を手にしました。',
