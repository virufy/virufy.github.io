  ...
  sectionAdvisors: {
    ...
    advisors: {
      ...
      jure: {
        ...
        texts: [
          'Científico Principal - Pinterest',
      ...
      madhav: {
        ...
        texts: [
          'Fundador - Green the Gene',
          'Ex Representante Global para la Juventud - UN EP',
      ...
      ronan: {
        ...
        texts: [
          'Ex Jefe de Marketing - Pivotal/VMWare',
      ...
      victor: {
        ...
        role: 'Asesor Ejecutivo',
        texts: [
          'Fundador y Presidente - China Silicon Valley',
      ...
      rok: {
        ...
        role: 'Asesor de Inteligencia Artificial',
        texts: [
          'Ingeniero de Investigación Senior',
      ...
      khwaja: {
        ...
        texts: [
          'MOSH, Vicepresidente, Miembro de la Junta',
      ...
      ayomide: {
        ...
        role: 'Asesor Clínico Ejecutivo',
        texts: [
          'PhD en Ciencias Biomédicas - Universidad de Illinois Chicago',
      ...
      les: {
        ...
        texts: [
          'Profesor de Ingeniería Eléctrica y de Computación - Universidad de Washington',
      ...
      tamer: {
        ...
        texts: [
          'Ex Dräger/Philips MedTech - Sueño y Cuidados Respiratorios',
      ...
      shirin: {
        ...
        texts: [
          'Ex Directora de Asuntos Clínicos, Medtronic',
      ...
      peter: {
        ...
        texts: [
          ...
          'Ph.D. en Ingeniería Eléctrica, Universidad de Stanford',
        ],
