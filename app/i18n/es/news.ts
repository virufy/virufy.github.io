...
const pressReleases: PressReleases = {
  ...
  pressReleaseCards: [
    ...
    {
      title:
        'BARDA apoya el desarrollo de aplicaciones digitales basadas en IA/ML para la detección de enfermedades infecciosas visuales y auditivas',
      date: 'Noviembre 2022',
    ...
    {
      title:
        'Embajador de One Young World Japón combate el COVID-19 utilizando IA',
      date: 'Mayo 2020',
    ...
    {
      title:
        'Embajadores de América del Norte en la primera línea de la respuesta al COVID-19',
      date: '2020',
    ...
    {
      title:
        'Miles asisten a los eventos digitales globales de OYW en julio: Un resumen de lo que te perdiste',
      date: 'Julio 2020',
      subText: 'One Young World',
