...
import { BodyBackground, CopdHeaderBackground } from '@/public/images/diseases';
import ExportedImage from 'next-image-export-optimizer';
import DiseasesNavbar from '../components/coughCheck/DiseasesNavbar';

const CopdPage = ({ params: { lang } }: { params: { lang: Locale } }) => {
  return (
